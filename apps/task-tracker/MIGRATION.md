...
1. Добавляем новую версию схемы для события ЗадачаСоздана: [task.created.v2](../../libs/schema-registry/src/schemas/task/created/v2.json) в которой добавлено поле jira_id
